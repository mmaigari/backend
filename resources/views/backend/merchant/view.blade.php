                                ...
                                <div class="row mt-3 mb-3 w-100  " style="margin:autocomplete">
                                    <div class="col-md-4 pr-0 pt-2">
                                        <div class="metric btn btn-primary w-100">
                                            <h6 class="metric-value text-white"> {{ settings()->currency }} {{ $singleMerchant->parcels->count()}} </h6>
                                            <p class="metric-label font-size-12 text-white">{{__('parcel.title')}} </p>
                                        </div>
                                    </div>
                                    <div class="col-md-4 pr-0 pt-2">
                                        <div class="metric btn btn-primary w-100">
                                    ...
                                    <div class="col-md-4 pr-0 pt-2 ">
                                        <div class="metric btn btn-primary w-100">
                                            <h6 class="metric-value text-white">{{ settings()->currency }} {{ $singleMerchant->parcels->sum('current_payable') }}</h6>
