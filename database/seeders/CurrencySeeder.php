...
class CurrencySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $currencies = [
        //     'Dollar'   => ['symbol' =>'$','exchange_rate' =>'1'],
        //     'Tk'       => ['symbol' =>'৳','exchange_rate' =>'100'],
        //     'Rupe'     => ['symbol' =>'₹','exchange_rate' =>'150'],
        //     'Euro'     => ['symbol' =>'€','exchange_rate' =>'200'],
        // ];
        // $i = 0;
        ...
        //     $currency->exchange_rate = $value['exchange_rate'];
        //     $currency->position      = $i;
        //     $currency->save();
        // }
        $b = '$b';
